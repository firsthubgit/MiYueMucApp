...
public class LrcParseUitls {
    private static final LrcParseUitls istance = new LrcParseUitls();

    public static final LrcParseUitls getIstance() {
        return istance;
    }

    private LrcParseUitls() {
    }
