...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public MediaNotificationManager(PlayerService service) throws RemoteException {
        mService = service;
        updateSessionToken();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        UtilLog.e(TAG, "Received intent with action " + action);
        switch (action) {
            case ACTION_PAUSE:
            ...
            case ACTION_STOP_CASTING:
                ...
                i.putExtra(MiYueConstans.CMD_NAME, MiYueConstans.CMD_STOP_CASTING);
                mService.startService(i);
                break;
            default:
                UtilLog.e(TAG, "Unknown intent ignored. Action=" + action);
        }
    }
...
//        }
    ...
    private final MediaControllerCompat.Callback mCb = new MediaControllerCompat.Callback() {
        ...
        public void onPlaybackStateChanged(@NonNull PlaybackStateCompat state) {
            ...
            UtilLog.e(TAG, "Received new playback state" +  state);
        ...
        public void onMetadataChanged(MediaMetadataCompat metadata) {
            mMetadata = metadata;
            UtilLog.e(TAG, "Received new metadata " + metadata);
            Notification notification = createNotification();
            if (notification != null) {
                mNotificationManager.notify(NOTIFICATION_ID, notification);
            }
        ...
        public void onSessionDestroyed() {
            ...
            UtilLog.e(TAG, "Session was destroyed, resetting to the new session token");
            try {
                updateSessionToken();
            } catch (RemoteException e) {
                UtilLog.e(TAG, e + "could not connect media controller");
            }
        }
    };

    private Notification createNotification() {
        UtilLog.e(TAG, "updateNotificationMetadata. mMetadata=" + mMetadata);
...
//            fetchBitmapFromURLAsync(fetchArtUrl, notificationBuilder);
    ...
    private void addPlayPauseAction(NotificationCompat.Builder builder) {
        UtilLog.e(TAG, "updatePlayPauseAction");
        String label;
        int icon;
    ...
    private void setNotificationPlaybackState(NotificationCompat.Builder builder) {
        UtilLog.e(TAG, "updateNotificationPlaybackState. mPlaybackState=" + mPlaybackState);
        if (mPlaybackState == null || !mStarted) {
            UtilLog.e(TAG, "updateNotificationPlaybackState. cancelling notification!");
            mService.stopForeground(true);
            return;
        }
        if (mPlaybackState.getState() == PlaybackStateCompat.STATE_PLAYING
                && mPlaybackState.getPosition() >= 0) {
            UtilLog.e(TAG, "updateNotificationPlaybackState. updating playback position to " +
            ...
            UtilLog.e(TAG, "updateNotificationPlaybackState. hiding playback position");
            builder
                    .setWhen(0)
                    .setShowWhen(false)
